...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabBarLayout = QtWidgets.QHBoxLayout(self.widget)
        self.tabBarLayout.setContentsMargins(0, 0, 0, 0)
        self.tabBarLayout.setSpacing(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Radar"))
